...
export const readerColumnClass =
  "min-h-0 flex-1 overflow-y-auto bg-[#0c0d12] px-6 py-10 md:px-12 md:py-12 lg:px-14";
...
export const readerArticleClass =
  "reader-article mx-auto w-full max-w-[42rem] space-y-[1.45em] antialiased [text-rendering:optimizeLegibility] selection:bg-accent/20 selection:text-zinc-100";
